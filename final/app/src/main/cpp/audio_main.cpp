...
JNIEXPORT void JNICALL
        Java_com_ece420_lab5_MainActivity_createSLEngine(JNIEnv *env, jclass, jint, jint);
JNIEXPORT void JNICALL
        Java_com_ece420_lab5_MainActivity_deleteSLEngine(JNIEnv *env, jclass type);
JNIEXPORT jboolean JNICALL
        Java_com_ece420_lab5_MainActivity_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass);
JNIEXPORT void JNICALL
        Java_com_ece420_lab5_MainActivity_deleteSLBufferQueueAudioPlayer(JNIEnv *env, jclass type);

JNIEXPORT jboolean JNICALL
        Java_com_ece420_lab5_MainActivity_createAudioRecorder(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_com_ece420_lab5_MainActivity_deleteAudioRecorder(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_com_ece420_lab5_MainActivity_startPlay(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_com_ece420_lab5_MainActivity_stopPlay(JNIEnv *env, jclass type);
}

extern "C" JNIEXPORT void JNICALL
Java_com_ece420_lab5_MainActivity_createSLEngine(
...
Java_com_ece420_lab5_MainActivity_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass type) {
